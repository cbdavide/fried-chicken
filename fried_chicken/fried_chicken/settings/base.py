"""
Django settings for fried_chicken project.
...
SECRET_KEY = '#*nu0m=wv0e!j!03br0$bhvq%*_ih!^xw8oy6bcy7m$vu=kl1$'
...
ROOT_URLCONF = 'fried_chicken.urls'
...
WSGI_APPLICATION = 'fried_chicken.wsgi.application'
